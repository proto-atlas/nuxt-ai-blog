...
// Nuxtのエラーハンドラに登録される共通エラーページ。
// 404 / 500 / その他全てが入ってくるため、statusCodeで文言を分岐する。
// layouts/default.vueは通らないので、ここでヘッダ + footerを再現する。
...
const message = computed(() => {
  if (status.value === 404) {
    return '指定されたURLの記事が削除されたか、移動した可能性があります。';
  }
  return (
