...
- Keyless UX: article list, search, tag filtering, article detail pages, dark mode, and the fixed AI-summary preview are visible without a key.
...
## Keyless and Key-Gated Scope

| Area | Access key | Notes |
|---|---:|---|
| Article list, search, tags, and article pages | No | Public blog UI. |
| AI-summary preview | No | Fixed preview only. It does not call Anthropic or any external AI API. |
