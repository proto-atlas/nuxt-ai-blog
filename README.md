...
| Playwright E2E | `npm run e2e -- --project=chromium` | **11 / 11 pass** (ai-summary 3 + blog 5 + a11y target-size 3、1 worker 固定) |
...
- Playwright 1.59 (E2E Chromium 11 シナリオ: blog 5 + AI 要約 3 page.route mock + a11y target-size 3)
...
| `e2e` | Playwright Chromium 11 シナリオ。`quality-gate` 通過後 |
